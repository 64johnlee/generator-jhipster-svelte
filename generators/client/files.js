	...
	libGateway: [
		{
			...
			templates: [
				...
				'admin/gateway/gateway-table.spec.js',
				'admin/gateway/service-instance-table.svelte',
				'admin/gateway/service-instance-table.spec.js',
			],
		},
	],
	libUserManagement: [
		{
			...
			templates: [
				...
				'account/change-password-form.spec.js',
				'account/forgot-password-form.svelte',
				'account/forgot-password-form.spec.js',
				'account/register-user-form.svelte',
				'account/register-user-form.spec.js',
				'account/reset-password-form.svelte',
				'account/reset-password-form.spec.js',
				'account/user-settings-form.svelte',
				'account/user-settings-form.spec.js',
